		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#logaligroupgestionempleados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"logaligroupgestionempleados-display": {
								"semanticObject": "logaligroupgestionempleados",
								"action": "display",
								"description": "Proyecto final: Gestión de empleados",
								"title": "Gestión de Empleados",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=logaligroup.gestionempleados",
									"url": sap.ui.require.toUrl("logaligroup/gestionempleados")
								}
							}
						}
					}
